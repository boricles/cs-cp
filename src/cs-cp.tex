...
%                                     \toctitle is used
%
\author{Aleix Garrido\inst{1} \and Jose Manuel Gomez-Perez\inst{1} \and Hal Warren\inst{2} \and \\ Boris Villazon-Terrazas\inst{1}}
...
\email{\{agarrido,jmgomez,bvillazon\}@isoco.com} \and
American Psychological Association, Washington, DC, USA\\
\email{hwarren@apa.org}
}
...
%We show how we enriched APA's existing RDF data model and produced an extended dataset with additional relations and information. Based on this dataset we describe a service layer which feeds the Collaboration Spheres and enables the expert finding capabilities. 
\end{abstract}
